...
<body>
    <header>
        ...
        <a href="#" class=logo><i class="fas fa-user-graduate"></i>EduPoint</a>

        <nav class="navbar">
            <ul>
                <li><a href="techindex.php">home</a></li>
                <li><a class="active" href="techindex.php#course">course</a></li>
...
<div class="insidecourse">
    ...
    <div class="updatecourse">
        <a href="#delete"><button class="btn">delete course</button></a>
        <a href="#edit"><button class="btn">edit course</button></a>
        <a href="add.php"><button class="btn">create quiz</button></a>
        <a href="teacher_portal.php"><button class="btn">modify quiz</button></a>
